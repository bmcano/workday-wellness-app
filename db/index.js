...
import { uploadProfilePicture, getUser, getExerciseInformation, updateExerciseInformation, getUserEmail } from './controllers/profileController.js';
...
app.get('/api/getUserEmail', getUserEmail);
