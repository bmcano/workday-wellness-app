...
import { getFriendLeaderboardCompleted, getFriendLeaderboardStreak, getGlobalLeaderboardCompleted, getGlobalLeaderboardStreak, getUserRecords, updateLifetimeStats } from './controllers/statisticsController.js';
...
app.post('/update_lifetime_stats', async (req, res) => updateLifetimeStats(req, res));
